...
export default function Scene8Reveal() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Dramatic cinematic reveal — slower and more deliberate
      tl.fromTo(".s8-preview", { scale: 0.5, opacity: 0, y: 150 }, { scale: 1, opacity: 1, y: -20, duration: 3, ease: "power3.out" })
  ...
  return (
    <section ref={containerRef} className="scene-full">
      <GradientLight position="center" intensity={0.3} size="80% 60%" className="s8-bg-glow opacity-0" />
